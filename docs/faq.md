...
Não. Os dados ficam armazenados localmente no navegador (localStorage). A aplicação foi projetada para ser standalone, sem backend.
...
- Criar, listar, marcar como concluída e deletar tarefas
- Confirmação antes de deletar
- Filtros por status (todas, pendentes, concluídas)
- Persistência automática no navegador
- Interface 100% em português brasileiro

### Posso contribuir com novas funcionalidades?

Sim! Abra uma issue propondo a funcionalidade e, se aprovada, um Pull Request seguindo o guia em `docs/development/setup.md`.
...
Não recomendado. O localStorage não é criptografado, e a aplicação não foi projetada para armazenar dados sensíveis (senhas, tokens, informações pessoais identificáveis).
